<template>
    ...
    <div class="invoice-box">
        ...
        <div class="table-responsive" v-for="(sale, index) in sales['sales']" :key="index">
            <div>
...
export default {
    ...
    methods:{
        async getSales(){
            ...
            return  await axios.get(`${process.env.VUE_APP_BASE_HOST_API}/sales-report?from=${from}&to=${to}`,{
                headers: {
