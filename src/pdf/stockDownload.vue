<template>
    <div class="invoice-box">
        ...
        <header class="text-center mb-4">
            ...
            <h2>
                <b>Persediaan Mitra Bogor Raya</b>
            </h2>
                ...
                <table class="table table-bordered">
                    ...
                    <tbody>
                        <tr v-for="(stock, index) in stocks" :key="index">
                            ...
                            <td> {{ stock['name'] }} </td>
                            <td> {{ stock['no'] }} </td>
                            <td> {{ stock['stock']['availableStock'] }}</td>
...
export default {
    ...
    methods:{
        async downloadStock(){
            ...
            return  await axios.get(`${process.env.VUE_APP_BASE_HOST_API}/stock/${this.$route.params.key}/download`,{
